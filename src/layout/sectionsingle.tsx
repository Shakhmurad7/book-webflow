  ...
  return (
    <>
        <Container>
            ...
            <Stack className={open===1? `block`:`none`} flexDirection={{xs:"column" , sm:'row'}} gap={3} justifyContent={'space-between'} pb={10}>
            ...
            <Stack className={open===2? `block`:`none`} flexDirection={{xs:"column" , sm:'row'}} gap={3} justifyContent={'space-between'} pb={10}>
                <Stack  width={{md:'500px' , xs:'100%'}} >
